...
import { AllocationMap, PostRecord, ProfileInput } from "@/lib/types";
      ...
      <Card>
        ...
        <CardContent className="grid gap-4 md:grid-cols-2">
          ...
          <div className="md:col-span-2">
            ...
            <Textarea value={memo} onChange={(e) => setMemo(e.target.value)} maxLength={200} />
          </div>
          <div className="md:col-span-2 space-y-2">
            <Label>配分合計: {total}% (100%必須)</Label>
          ...
          <div className="md:col-span-2 flex flex-wrap gap-2">
            <Button onClick={onSubmit} disabled={total !== 100 || auth.aal !== "aal2"}>審査へ提出</Button>
